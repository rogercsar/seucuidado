    ...
    async function load() {
      try {
        ...
        if (authUser) {
          ...
          // Fallback para mocks se não autenticado
          setUser({ name: 'Usuário de Teste', email: 'usuario@teste.com', picture: 'https://i.pravatar.cc/150?u=a042581f4e29026704d' });
          setUpcoming([{ id: 'a1', title: 'Enfermeira — Ana Souza', date: '2025-11-12 10:00', price: 150 }]);
          setHistory([{ id: 'h1', title: 'Fisioterapeuta — Carlos Lima', date: '2025-10-20 15:00', price: 120 }]);
        }
      } catch (e) {
